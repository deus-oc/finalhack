    ...
    id.forEach( (value,index) => {
        ...
        cards.innerHTML = `<!-- Sample card 1-->
          <div class="card" style="margin-bottom: 20px;">
            ...
            <!-- Button = api call-->
              <button id = "btn-${index}" type="button" class="btn btn-primary">Launch demo modal</button>
              <button style = "display : none" id = "real-${index}" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">Launch demo modal</button>
            <!-- Modal -->
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"></h5>
                      <div id = "modal-title-${index}"><b>${idname[index]}</b></div>
